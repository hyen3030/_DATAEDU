...
csv_path = "./dday_kbnews_230531(230509~230530).csv"
...
anoth_url = ""
d.get(anoth_url)
anoth_areaname = '/html/body/div[2]/div[4]/div/section/div/div[1]/div[1]/div/div/strong'
area = d.find_element(By.XPATH, anoth_areaname).text
print(area)
...
for a in range(2, 12):
        ...
        for dg in range(1, 21):
            ...
            if (dg/2 != 1):
                ...
                xpath_text_1 = '/html/body/div[2]/div[4]/div/section[2]/div/div[1]/div[1]/div/div[1]/p'
                text = d.find_element(By.XPATH, xpath_text_1).text
                ...
                xpath_text_1 = '/html/body/div[2]/div[4]/div/section[2]/div/div[1]/div[1]/div/div[1]'
                text = d.find_element(By.XPATH, xpath_text_1).text
            ...
            """ 
            savestart_date = datetime(2023,5,9)
            saveend_date = datetime(2023,5,30) """
            """ if "2023/05/09" <= date[3:13] <= "2023/05/30":
            # 저장하는 코드 작성
                pass
            else:
            # 예외 조건에 해당하는 경우 저장하지 않음
                sys.exit() """
            ...
            df.to_csv("./dday_kbnews_230531(230509~230530).csv", mode = 'a', encoding='utf-8', header=False, index=False)
            df.head()
            df.tail()
sleep(2)
d.back()
