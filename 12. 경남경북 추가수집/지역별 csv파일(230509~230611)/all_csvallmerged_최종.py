...
folder_path = 'E:/ICT인턴쉽/2023-1/보고서 작성_프로젝트 폴더/12. 경남경북 추가수집/지역별 csv파일(230509~230530)'
...
if len(df_list) > 0:
    ...
    merged_df.to_csv('./dday_kbnews_230531_allmerged.csv', encoding='utf-8-sig', index=False)
else:
